        ...
        <div class="card">
            <div class="card-body p-5">
                ...
                <form action="{{ route('userregister') }}" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="full-name" class="form-label">Company name</label>
                        <input type="text" class="form-control" id="company-name" placeholder="Company Name" name="name" value="{{ old('name') }}">
                        @error('name')
                        <div class="">
                            {{$message}}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="company-type" placeholder="Type Of Products You Sell" name="name" value="{{ old('name') }}">
                        @error('name')
                        <div class="">
                            {{$message}}
                        </div>
